...
/**
 * parser.cpp - Parser for a GCode line, providing a parameter interface.    parser.cpp - GCode 行的解析器，提供参数接口。
 */
...
// Create a global instance of the GCode parser singleton  创建 GCode 解析器单例的全局实例
GCodeParser parser;
