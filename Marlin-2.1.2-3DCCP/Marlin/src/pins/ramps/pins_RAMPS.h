...
#endif
#ifndef TEMP_1_PIN
  #define TEMP_1_PIN                          13  // Analog Input L:原15
#endif
#ifndef TEMP_BED_PIN
...
//
// SPI for MAX Thermocouple  用于 MAX 热电偶的 SPI
//
...
#if FET_ORDER_EFB                                 // Hotend, Fan, Bed  热端，风扇，热床
...
//
   ...
   *
   * Hardware serial communication ports.                               硬件串行通信端口。
   * If undefined software serial is used according to the pins below   如果根据下面的管脚使用未定义的软件序列号
   *
   * Serial2 -- AUX-4 Pin 18 (D16 TX2) and AUX-4 Pin 17 (D17 RX2)       Serial2——AUX-4 引脚 18 (D16 TX2) 和 AUX-4 引脚 17 (D17 RX2)
   * Serial1 -- Pins D18 and D19 are used for Z-MIN and Z-MAX           Serial1——引脚 D18 和 D19 用于 Z-MIN 和 Z-MAX
   */
